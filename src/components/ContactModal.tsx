            ...
            <div className="relative p-6 sm:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="w-full bg-accent text-black font-black uppercase tracking-widest py-3.5 rounded-[var(--btn-radius)] transition-all duration-300 mt-1 shadow-[0_10px_30px_rgba(163,255,0,0.2)] flex items-center justify-center gap-3 text-xs"
                >

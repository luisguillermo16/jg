...
const TestimonialsSection: FC = () => (
  <section className="relative bg-[#030d05] min-h-screen py-24 md:h-screen md:py-0 px-6 md:px-12 flex flex-col justify-center" style={{ scrollSnapAlign: 'start', scrollSnapStop: 'always' }}>

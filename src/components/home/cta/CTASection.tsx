...
const CTASection: FC = () => (
  <section className="relative min-h-screen py-24 md:h-screen md:py-0 px-6 bg-[#030d05] flex flex-col justify-center" style={{ scrollSnapAlign: 'start', scrollSnapStop: 'always' }}>
